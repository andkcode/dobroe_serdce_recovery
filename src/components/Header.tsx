...
import logo from "../assets/language/logo.png";
			...
			<nav id="nav">
				<div className="nav-inner">
					...
					<div className="nav-socials">
						<a href="https://wa.me/77788100900" target="_blank" rel="noopener noreferrer" className="nav-social" title="WhatsApp">
						...
						<a href="https://t.me/+77788100900" target="_blank" rel="noopener noreferrer" className="nav-social" title="Telegram">
						...
						<a href="https://www.instagram.com/czmfreedom" target="_blank" rel="noopener noreferrer" className="nav-social" title="Instagram">
