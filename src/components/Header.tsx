			...
			<nav id="nav">
				<div className="nav-inner">
					...
					<div className="nav-socials">
						...
						<a href="https://t.me/czm_freedom" target="_blank" rel="noopener noreferrer" className="nav-social" title="Telegram">
						...
						<a href="https://instagram.com/czmfreedom" target="_blank" rel="noopener noreferrer" className="nav-social" title="Instagram">
